...
setwd("/media/fortytwo/Heart_of_Gold/selscan/SelScan_scores/Selection_Scan_UGD_KYWall/MAU/NORM/")

XPnsl <- read.table("./XPnsl_plt_M.final", header = FALSE)
...
ggsave(filename = "/home/fortytwo/UGD_XPnsl.png", plot = manhplot, dpi = 600, height = 10, width = 10)
